...
def draw_cards(player, dealer, reveal):
    for i in range(len(player)):
        ...
        screen.blit(font.render(player[i], True, 'black'), (80 +70*i, 615 +5*i))
    ...
    for i in range(len(dealer)):
        ...
        if i != 0 or reveal:
            ...
            screen.blit(font.render(dealer[i], True, 'black'), (80 +70*i, 315 +5*i))
        else:
            screen.blit(font.render('???', True, 'black'), (80 +70*i, 165 +5*i))
            screen.blit(font.render('???', True, 'black'), (80 +70*i, 315 +5*i))
